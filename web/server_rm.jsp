    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav admin-header-list">
            ...
            <li class="kuanjie">
                ...
                <a href="server_rm.jsp" id="selectLi">聊天记录管理</a>
            ...
            <div class="am-popup-bd">
                ...
                <form class="modForm am-form">
                    ...
                    <div class="am-form-group">
                        ...
                        <input type="text" name="user-input" id="user-input" placeholder="请输入标题" disabled>
                    </div>
                    <div class="am-form-group">
                        <span class="modDiv-label">发送时间</span>
                        <input type="text" name="time-input" id="time-input" placeholder="请输入标题" disabled>
                    </div>
                    <div class="am-form-group">
                        <span class="modDiv-label">内容</span>
                        <input type="text" name="content-input" id="content-input" placeholder="请输入标题" >
                    </div>

                    <div class="am-form-group">
                        <span class="modDiv-label">所属聊天室</span>
                        <input type="text" name="room-input" id="room-input" placeholder="无" disabled>
                    </div>
                    <div class="am-form-group">
                        <span class="modDiv-label">发给好友</span>
                        <input type="text" name="friend-input" id="friend-input"placeholder="无"disabled>
                    </div>
...
<script type="text/javascript" src="assets/js/ser_rm.js"></script>
</html>
