...
public class PageBean<T> {
    ...
    public PageBean(int pageNum, int pageSize, int totalRecord) {
        ...
        if (pageNum >= totalPage) this.pageNum = totalPage;
        ...
        if (totalPage <= 5) {
            ...
            if (end > this.totalPage) {
                ...
                this.end = totalPage;
                this.start = end - 5 >= 1 ? end - 5 : 1;
            }
        }
    }

    public PageBean(int pageNum, int pageSize, List<T> records) {
        this(pageNum, pageSize, records.size());
    }
